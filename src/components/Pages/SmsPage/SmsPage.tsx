                ...
                <div className="grid grid-cols-1 items-stretch gap-5 lg:grid-cols-5">
                    <div className="flex flex-col gap-5 lg:col-span-3">
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <button
                                onClick={() => { }}
                                className="group flex cursor-pointer items-center justify-between rounded-2xl border border-gray-200 bg-white p-5 text-left shadow-sm transition hover:border-blue-200 hover:shadow-md"
                            >
                                <Link
                            ...
                            <button
                                onClick={() => { }}
                                className="group flex cursor-pointer items-center justify-between rounded-2xl border border-gray-200 bg-white p-5 text-left shadow-sm transition hover:border-[#039A63]/30 hover:shadow-md"
                            >
                                <Link href={`/dashboard/sms/history`} className="flex items-center gap-4">
